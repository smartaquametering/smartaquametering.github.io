...
// +++ Ph. Eur - 2020-10	: European Pharmacopoeia, Chapter 2.2.2, Coloration of Liquids
...
var ColorIndex = {
	0:	{
			...
			BeamAngle: '180 [°]',
			BeamAngleID: 0,
			WavelengthRange: '<=380 nm to >=780 nm',
			WavelengthIncrement: '<= 5 nm',
			ColorSpace: 'n/a',
			Observer: 'CIE1931StdObs',
			ObserverID: 0,
			ReferenceWhite: 'C',
			ReferenceWhiteID: 2,
...
//
			...
			Step: '',
			Unit: 'm-1',
			Description: 'SAC436 describes the yellow colouring of potable-, used- or wastewater. The measuring range is indicated in m-1 (Extinction per meter optical path lenght)',
	...
	2:	{
			...
			Step: '',
			Unit: 'EBC units',
			Description: 'European standard for beers, malts and caramels and similarly colored liquids',
	...
	3:	{
			...
			Step: '',
			Unit: 'ASBC units',
			Description: 'American standard for color grading of beers',
	...
	4:	{
			...
			Step: '',
			Unit: 'ICUMSA units',
			Description: 'For sugar solutions & syrups',
	...
	5:	{
			...
			Step: '',
			Unit: 'H-I units',
			Description: 'For cosmetic industry, color evaluation of fat derivatives and surfactant liquids',
	...
	10:	{
			...
			Step: '',
			Unit: '',
			Description: 'XYZ by tristimulus method',
...
//
			...
			Step: '',
			Unit: 'YI units',
			Description: 'For the determination of the degree of yellowness of transparent liquids',
			DeterminationMethod: 'Calculated from CIE-XYZ (C/2°) coordinates',
			MeasurementMode: 'Transmittance',
			MeasurementModeID: 0,
			BeamAngle: '180 [°]',
			BeamAngleID: 0,
...
//				['YellownessIndex-'+YI]: Lab.L + ', ' + Lab.a + ', ' + Lab.b
	...
	12:	{
			...
			Step: '',
			Unit: 'Pt-Co units',
			Description: 'For water and other clear liquids such as plasticizers, solvents and petroleum spirits, clear oils, chemicals and petrochemicals such as glycerine, solvents, carbon tetrachloride, and petroleum spirits',
	...
	13:	{
			...
			// 50 mm Küvette
			//
			// d = 5			Thickness of the solution layer (Optical Path Length of cuvette) [cm]
			// NULL-Reference	Distilled water
			//
			...
			Step: '',
			Unit: '',
			Description: 'For colored waters and tinted liquids',
			DeterminationMethod: '???',
			MeasurementMode: 'Transmittance',
			MeasurementModeID: 0,
			BeamAngle: '180 [°]',
	...
	14:	{
			...
			//
			Name: 'Iodine Color',
			Standard: 'DIN-6162-2014',
			Note: '',
			Range: '0-500',
			Step: '',
			Interval: 10,
			Unit: 'mg of iodine per 100ml potassium iodide solution',
			Description: 'For solvents, plasticisers, resins, oils and fatty acids ranging from yellow to brown. For 1 or less on the Iodine scale, the Pt-Co colour scale is applicable.',
			DeterminationMethod: '???',
			MeasurementMode: 'Transmittance',
			MeasurementModeID: 0,
			BeamAngle: '180 [°]',
	...
	15:	{
			...
			//
			Name: 'Gardner Color',
			Standard: 'ASTM D6166, ASTM D1544',
			Note: '',
			Range: '0-18',
			Step: '',
			Unit: 'Gardner color units',
			Description: 'For oils & chemicals ranging from pale yellow to red, including lecithins, resins, drying oils & fatty acids',
			DeterminationMethod: 'Calculated from CIE-xyY (C/2°) coordinates',
			MeasurementMode: 'Transmittance',
			MeasurementModeID: 0,
			BeamAngle: '180 [°]',
			BeamAngleID: 0,
...
//
			Name: 'ASTM Color',
			Standard: 'ASTM D6045, ASTM D1500',
			Note: '',
			Range: '0.5–8',
			Step: '0.5',
			Unit: 'ASTM color units',
			Description: 'For a wide range of petroleum products including lubricating oils, heating oils and diesel fuel oils',
			DeterminationMethod: 'Calculated from CIE-XYZ (C/2°) coordinates',
			MeasurementMode: 'Transmittance',
			MeasurementModeID: 0,
			BeamAngle: '180 [°]',
...
//				['ASTMColor-'+ASTM]: Lab.L + ', ' + Lab.a + ', ' + Lab.b
	...
	17:	{
			...
			//
			Name: 'Saybolt Color',
			Standard: 'ASTM D6045, ASTM D156',
			Note: '',
			Range: '-16 - +30',
			Step: '',
			Unit: 'Saybolt color unit',
			Description: 'For light colored petroleum products including aviation fuels, kerosene white mineral oils, hydrocarbon solvents and petroleum waxes',
			DeterminationMethod: 'Calculated from CIE-XYZ (C/2°) coordinates',
			MeasurementMode: 'Transmittance',
			MeasurementModeID: 0,
			BeamAngle: '180 [°]',
			...
			ReferenceWhite: 'C',
			ReferenceWhiteID: 2,
			ReferenceCellPathLength: 10.0,
			ReferenceNull: 'Psychrometric lightness of the dodecane',
			ChartBackground: 'CIE-Lab-L75-Saybolt-Color.png',
			ChartCurveType: 'none',
			ChartLineWidth: 0,
			Value: 'Saybolt',
			Index: {
//				['SayboltColor-'+Saybolt]: Lab.L + ', ' + Lab.a + ', ' + Lab.b
	...
	18:	{
			...
			Step: '',
			Unit: 'EP color unit',
			Description: 'For pharmaceutical solutions',
			DeterminationMethod: 'Calculated from CIE-XYZ (C/2°) coordinates',
			MeasurementMode: 'Transmittance',
			MeasurementModeID: 0,
			BeamAngle: '180 [°]',
			...
			Index: {
				...
				'EP-B8': '98.7, -0.9, 4.1',
				'EP-B9': '99.1, -0.7, 2.9',
				'EP-BY1': '78.2, 7.6, 70.3',
				'EP-BY2': '82.8, 2.9, 61.7',
				'EP-BY3': '87.8, -1.9, 50.3',
				'EP-BY4': '93.5, -5.5, 33.4',
				'EP-BY5': '96.6, -5.3, 20.4',
				'EP-BY6': '98.6, -3.3, 9.9',
				'EP-BY7': '99.3, -1.9, 5.4',
				'EP-Y1': '86.3, 2.8, 72.5',
				'EP-Y2': '89.3, -2.0, 63.4',
				...
				'EP-Y6': '99.2, -3.9, 10.1',
				'EP-Y7': '99.6, -2.3, 5.5',
				'EP-GY1': '95.8, -21.6, 68.3',
				'EP-GY2': '97.4, -19.9, 53.1',
				'EP-GY3': '98.5, -16.8, 39.5',
				'EP-GY4': '99.0, -13.3, 28.5',
				'EP-GY5': '99.3, -9.8, 19.8',
				'EP-GY6': '99.7, -6.1, 11.7',
				'EP-GY7': '99.8, -3.5, 6.5',
				'EP-R1': '71.3, 35.7, 65.4',
				'EP-R2': '76.2, 29.5, 53.9',
				'EP-R3': '82.1, 21.3, 39.7',
				'EP-R4': '85.8, 16.4, 31.5',
				'EP-R5': '90.0, 11.0, 22.4',
				'EP-R6': '94.6, 5.2, 12.4',
				'EP-R7': '97.8, 2.0, 5.4'
			}
		},
	...
	21:	{
			...
			Unit: '',
			Description: '',
			DeterminationMethod: 'Calculated from CIE-XYZ (D65/2°) coordinates',
			MeasurementMode: 'Transmittance',
			MeasurementModeID: 0,
			BeamAngle: '180 [°]',
			BeamAngleID: 0,
...
{
	ColorScale = ColorIndex[SelectedColorScale];
	...
	switch (SelectedColorScale)
	{
		case 0:		// None
			break;
		case 1:		// Spectral Absorption Coefficient (SAC)
			// T = IT / I0
			// Eλ = - log ( T ) = log ( 1 / T )
			// SACλ = Eλ / d * 100
			//
...
//			ColorIndex[11]['ChartBackground'] = 'CIE-Lab-L'+Round(Lab.L/10, 0)*10+'-Yellowness-Color.png';
			CIECTX = YellownessIndex2Canvas(CIECanvas, CIECTX, Lab.L);
//			CIECTX = YellownessIndex2CanvasXXX(CIECanvas, CIECTX, Lab.L);

			break;
		case 12:	// Platinum-Cobalt/Hazen/APHA Color
			//
			// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
			//
			// Absorbance Tolerance Limits for No. 500 PlatinumCobalt Stock Solution (ASTM D5386–04, CIE C/2o, d=1cm)
			...
			// of clear liquids correlated to the visual ASTM D1209 method.
			//
//			ColorIndex[12]['ChartBackground'] = 'CIE-Lab-L'+Round(Lab.L/10, 0)*10+'.png';
		...
		case 13:	// ADMI Color
			...
			// from the widely used Pt-Co/Hazen/APHA/Hazen Units.
			//
//			ColorIndex[13]['ChartBackground'] = 'CIE-Lab-L'+Round(Lab.L/10, 0)*10+'.png';
			CIECTX = Lab2Canvas(CIECanvas, CIECTX, Lab.L);
			break;
		case 14:	// Iodine Color
			//
			// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
			//
			// Fig. 15 shows the color graphs of the Iodine, Hazen (APHA) and Gardner scales in the CIE-Labcolor space
			...
			// 
			//
//			ColorIndex[14]['ChartBackground'] = 'CIE-Lab-L'+Round(Lab.L/10, 0)*10+'.png';
			CIECTX = Lab2Canvas(CIECanvas, CIECTX, Lab.L);
			break;
		case 15:	// Gardner Color
			// Calculation:
			//
			// GTM = G1 + GF
			//
			...
			//		'GardnerColor-18': '0.6477, 0.3521, 4'
			//
//			ColorIndex[15]['ChartBackground'] = 'CIE-Lab-L'+Round(Lab.L/10, 0)*10+'.png';
			CIECTX = Lab2Canvas(CIECanvas, CIECTX, Lab.L);
			break;
		case 16:	// ASTM Color
			// Calculated from CIE-XYZ values
...
//			ColorIndex[16]['ChartBackground'] = 'CIE-Lab-L'+Round(Lab.L/10, 0)*10+'-ASTM-Color.png';
			CIECTX = ASTMColor2Canvas(CIECanvas, CIECTX, Lab.L);
			break;
		case 17:	// Saybolt Color
			//
			// d = 10.0			Thickness of the solution layer (Optical Path Length of cuvette) [cm]
			//
...
//			ColorIndex[17]['ChartBackground'] = 'CIE-Lab-L'+Round(Lab.L/10, 0)*10+'-Saybolt-Color.png';
			CIECTX = SayboltColor2Canvas(CIECanvas, CIECTX, Lab.L);
			break;
		case 18:	// European Pharmacopoeia (EP) Color
//			ColorIndex[18]['ChartBackground'] = 'CIE-Lab-L'+Round(Lab.L/10, 0)*10+'.png';
			CIECTX = Lab2Canvas(CIECanvas, CIECTX, Lab.L);
			break;
		case 19:	// US Pharmacopoeia (USP) Color
//			ColorIndex[19]['ChartBackground'] = 'CIE-Lab-L'+Round(Lab.L/10, 0)*10+'.png';
			CIECTX = Lab2Canvas(CIECanvas, CIECTX, Lab.L);
			break;
		case 20:	// Chinese Pharmacopoeia (CP) Color
//			ColorIndex[20]['ChartBackground'] = 'CIE-Lab-L'+Round(Lab.L/10, 0)*10+'.png';
			CIECTX = Lab2Canvas(CIECanvas, CIECTX, Lab.L);
			break;
		case 21:	// ColorChecker Patches (2005)
//			ColorIndex[21]['ChartBackground'] = 'CIE-Lab-L'+Round(Lab.L/10, 0)*10+'.png';
			CIECTX = Lab2Canvas(CIECanvas, CIECTX, Lab.L);
			break;
	}
	return(ColorScale);
